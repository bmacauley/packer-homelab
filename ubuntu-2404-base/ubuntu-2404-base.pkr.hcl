# Ubuntu 24.04 Base Template for Proxmox
# Clones from ubuntu-2404-raw and adds qemu-guest-agent
#
# Workflow:
#   ubuntu-2404-raw (Ansible) → ubuntu-2404-base (this Packer build)
...
variable "clone_vm" {
  type        = string
  default     = "ubuntu-2404-raw"
  description = "Name of the raw template to clone from"
}
...
variable "template_description" {
  type        = string
  default     = "Ubuntu 24.04 LTS - Base template with qemu-guest-agent"
...
source "proxmox-clone" "ubuntu-2404-base" {
...
build {
  ...
  sources = ["source.proxmox-clone.ubuntu-2404-base"]
